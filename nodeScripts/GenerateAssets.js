...
async function generateAtlases() {
    ...
    try {
        ...
        const file = join(assetsPath, "assetNames/spriteSheets.js");
...
async function generateAudioAssets() {
    ...
    try {
        ...
        const file = join(assetsPath, "assetNames/audio.js");
...
async function generateShaders() {
    ...
    try {
        ...
        const file = join(assetsPath, "assetNames/shaders.js");
        const data = `export const shaders = ${JSON.stringify(filesNamesAndPath)}`;
        await fs.writeFile(file, data);
        await runPrettierOn(file);
    } catch (e) {
        console.log(e.message);
...
async function generateVideos() {
    ...
    try {
        ...
        const file = join(assetsPath, "assetNames/videos.js");
        const data = `export const videos = ${JSON.stringify(filesNamesAndPath)}`;
        await fs.writeFile(file, data);
        await runPrettierOn(file);
    } catch (e) {
        console.log(e.message);
...
async function generateSpines() {
    ...
    try {
        ...
        const file = join(assetsPath, "assetNames/spines.js");
        const data = `export const spines = ${JSON.stringify(spineFiles)}`;
        await fs.writeFile(file, data);
        await runPrettierOn(file);
    } catch (e) {
        console.log(e.message);
